            ...
            <div className="container mx-auto max-w-4xl space-y-6">
                ...
                <div className="flex flex-wrap gap-2">
                    <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors border ${!selectedProductId
                    ...
                    {products.map((product) => (
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors border ${selectedProductId === product._id
                                        ...
                                        <div className="text-right">
                                            ...
                                            {price.comparison && (
                                                <p className="text-xs text-neutral-400">
                                                    Sebelumnya: {formatRupiah(price.comparison.harga_sebelumnya)}
                                                </p>
                                            )}
                                        </div>
                                    </div>
