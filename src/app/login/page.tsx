...
export default function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-violet-600/20 rounded-full blur-[100px] translate-x-1/2 translate-y-1/2" />

            <Card className="w-full max-w-md relative z-10">
                <div className="flex flex-col items-center mb-8">
                    <div className="bg-blue-600/10 p-4 rounded-2xl mb-4 text-blue-500">
                        <Wallet size={32} />
                    </div>
                    ...
                    <p className="text-neutral-500 text-sm mt-2">
                        Masuk untuk mengelola keuangan toko Anda
                    </p>
                </div>
